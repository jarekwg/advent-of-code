...
class Cube:
    ...
    def follow_instructions(self, instructions: str, wrap: str) -> None:
        while instructions:
            truncate = 1
            if instructions[0] == "L":
                cube.turn_left()
...
cube.follow_instructions(instructions, wrap="flat")
# cube.draw()
print(f"Part 1: {cube.utter_password()}")

cube = Cube(cube_data.splitlines())
cube.follow_instructions(instructions, wrap="3D")
# cube.draw()
